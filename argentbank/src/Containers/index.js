    ...
    <div className="hero">
      ...
      <section className="features">
        ...
        <div className="feature-item">
          <img src={Chat} alt="Chat Icon" className="feature-icon"></img>
        ...
        <div className="feature-item">
          <img src={Money} alt="Chat Icon" className="feature-icon"></img>
        ...
        <div className="feature-item">
          <img src={Security} alt="Chat Icon" className="feature-icon"></img>
